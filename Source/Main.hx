...
class Main extends Sprite {
	...
	public function new() {
		...
		var animationData:AnimationData = Json.parse(Assets.getText("assets/ninja-girl/Animation.json"));
		var atlasData:AtlasData = Json.parse(Assets.getText("assets/ninja-girl/spritemap.json"));
		var bitmapData:BitmapData = Assets.getBitmapData("assets/ninja-girl/spritemap.png");
